...
local MATERIALS_ITEMS = {
    ...
    "BundleUp.TreeBranchR",
    "BundleUp.TreeBranchSR",
    "BundleUp.WoodenRodR",
    "BundleUp.WoodenRodSR",
    "BundleUp.LargeBranchR",
    "BundleUp.LargeBranchSR",
    "BundleUp.SaplingR",
    "BundleUp.SaplingSR",
    "BundleUp.LongStickR",
    "BundleUp.LongStickSR",
    "BundleUp.MediumHandleR",
    "BundleUp.MediumHandleSR",
    "BundleUp.LargeHandleR",
    "BundleUp.LargeHandleSR",
    "BundleUp.LeadPipeR",
    "BundleUp.LeadPipeSR",
    "BundleUp.CopperSheetR",
    "BundleUp.CopperSheetSR",
    "BundleUp.GoldSheetR",
    "BundleUp.GoldSheetSR",
    "BundleUp.TreeBranchLR",
    "BundleUp.TreeBranchLSR",
    "BundleUp.WoodenRodLR",
    "BundleUp.WoodenRodLSR",
    "BundleUp.LargeBranchLR",
    "BundleUp.LargeBranchLSR",
    "BundleUp.SaplingLR",
    "BundleUp.SaplingLSR",
    "BundleUp.LongStickLR",
    "BundleUp.LongStickLSR",
    "BundleUp.MediumHandleLR",
    "BundleUp.MediumHandleLSR",
    "BundleUp.LargeHandleLR",
    "BundleUp.LargeHandleLSR",
    "BundleUp.LeadPipeLR",
    "BundleUp.LeadPipeLSR",
    "BundleUp.CopperSheetLR",
    "BundleUp.CopperSheetLSR",
    "BundleUp.GoldSheetLR",
    "BundleUp.GoldSheetLSR",
