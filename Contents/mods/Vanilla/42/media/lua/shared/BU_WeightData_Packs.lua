...
BU.Bundles["BundleUp.IronBandSmallBox"] = { base = "Base.IronBandSmall", count = 40 }
BU.Bundles["BundleUp.IronBarHalfBox"] = { base = "Base.IronBarHalf", count = 20 }
BU.Bundles["BundleUp.IronBarQuarterBox"] = { base = "Base.IronBarQuarter", count = 40 }
BU.Bundles["BundleUp.IronBlockBox"] = { base = "Base.IronBlock", count = 10 }
BU.Bundles["BundleUp.IronChunkBox"] = { base = "Base.IronChunk", count = 40 }
BU.Bundles["BundleUp.IronPieceBox"] = { base = "Base.IronPiece", count = 200 }
BU.Bundles["BundleUp.RakeHeadBox"] = { base = "Base.RakeHead", count = 10 }
BU.Bundles["BundleUp.SteelBarHalfBox"] = { base = "Base.SteelBarHalf", count = 20 }
BU.Bundles["BundleUp.SteelBarQuarterBox"] = { base = "Base.SteelBarQuarter", count = 40 }
